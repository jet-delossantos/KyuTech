...
class SatDataView extends SatData {
    ...
    public function showAllBytes($argumentslist) {
        $results = $this->getAllBytes($argumentslist);
        return $results;
    }

    public function showAllBytesByGst($gst, $argumentslist) {
        $results = $this->getAllBytesByGst($gst, $argumentslist);
        return $results;
    }
